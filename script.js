...
function data(result, word) {
  ...
  if(result.title) {
    ...
    document.querySelector(".word span").innerText = `${result[0].meanings[0].partOfSpeech} ${phonetics}`;
    document.querySelector(".meaning span").innerText = result[0].meanings[0].definitions[0].definition.split(";")[0];
    document.querySelector(".example span").innerText = result[0].meanings[0].definitions[0].example || "Not Available";
...
//*********************************** For search Input Add Event Listener Function ************************************
...
//*********************************** For volume Add Event Listener Function *******************************************
volumeIcon.addEventListener("click", () => {
  if (audio.attributes[1].nodeValue.length === 0) {
    no_audio1 = new Audio("https://api.dictionaryapi.dev/media/pronunciations/en/not-us.mp3");
    no_audio2 = new Audio("https://api.dictionaryapi.dev/media/pronunciations/en/available-us.mp3");
    no_audio1.play();
    setTimeout(() => {
      no_audio2.play();
    }, 150);
...
//*********************************** For remove Icon Add Event Listener Function *************************************
